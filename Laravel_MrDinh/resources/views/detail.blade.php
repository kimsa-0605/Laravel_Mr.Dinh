...
<div class="inner-header">
  <div class="container">
    <div class="pull-left">
      <h6 class="inner-title">San Pham {{$products->name}}</h6>
    </div>
    <div class="pull-right">
      <div class="beta-breadcrumb font-large">
        <a href="/cake">Home</a> / <span>Details</span>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-sm-9">
          ...
          <div class="col-sm-8">
            <div class="single-item-body">
              ...
              <p class="single-item-price" style="text-align:left;font-size: 15px;">
                <span> @if($products->promotion_price==0)
                  ...
                  <div class="card-body">
                    ...
                    <form method="post" action="">
                      ...
                      <div class="form-group">
                        <textarea class="form-control" name="comment" style="max-width: 500px;" required></textarea>
                      </div>
        ...
        <div class="beta-products-list">
          <h4 style="margin-bottom: 20px;">Related Products</h4>
          <div class="row">
            @foreach($splienquan as $sp)
            <div class="col-sm-4">
              <div class="single-item">
                <div class="single-item-header">
                  <a href="/product-detail/{{$sp->id}}"><img src="/image/product/{{$sp->image}}" style="height: 250px; object-fit:cover" alt=""></a>
                </div>
                ...
                <div class="single-item-caption">
                  <a class="add-to-cart pull-left" href=""><i
                      class="fa fa-shopping-cart"></i></a>
                  <a class="beta-btn primary" href="/product-detail/{{$sp->id}}">Details <i class="fa fa-chevron-right"></i></a>
                  <div class="clearfix"></div>
                </div>
              </div>
            </div>
          ...
          <div class="widget-body">
            <div class="beta-sales beta-lists">
              <div class="media beta-sales-item">
                <a class="pull-left" href="product.html"><img src="image/product/sales/1.jpg"
                    alt=""></a>
              ...
              <div class="media beta-sales-item">
                <a class="pull-left" href="product.html"><img src="image/product/sales/2.jpg"
                    alt=""></a>
                <div class="media-body">
                  Sample Woman Top
                  <span class="beta-sales-price">$34.55</span>
              ...
              <div class="media beta-sales-item">
                <a class="pull-left" href="product.html"><img src="image/product/sales/3.jpg"
                    alt=""></a>
                <div class="media-body">
                  Sample Woman Top
                  <span class="beta-sales-price">$34.55</span>
              ...
              <div class="media beta-sales-item">
                <a class="pull-left" href="product.html"><img src="image/product/sales/4.png"
                    alt=""></a>
                <div class="media-body">
                  Sample Woman Top
                  <span class="beta-sales-price">$34.55</span>
