    ...
    <div class="container">
        ...
        <div class="pull-right">
            <div class="beta-breadcrumb font-large">
                <a href="/cake">Home</a> / <span>Giới thiệu</span>
            </div>
        </div>
    ...
    <div id="content">
            ...
            <div class="history-slider">
                ...
                <div class="history-slides">
                    ...
                    <div>
                        <div class="row">
                            <div class="col-sm-5">
                                <img src="assets/dest/images/history2.jpg" alt="">
                            </div>
                            <div class="col-sm-7">
                    ...
                    <div>
                        <div class="row">
                            <div class="col-sm-5">
                                <img src="assets/dest/images/history3.jpg" alt="">
                            </div>
                            <div class="col-sm-7">
                    ...
                    <div>
                        <div class="row">
                            <div class="col-sm-5">
                                <img src="assets/dest/images/history4.jpg" alt="">
                            </div>
                            <div class="col-sm-7">
        ...
        <div class="row">
            <div class="col-sm-6 wow fadeInLeft">
                <div class="beta-person media">
                    ...
                    <img class="pull-left" src="assets/dest/images/history2.jpg" style="height: 300px; margin-bottom: 20px;" alt="">
            ...
            <div class="col-sm-6 wow fadeInRight">
                <div class="beta-person media ">
                    ...
                    <img class="pull-left" src="assets/dest/images/history3.jpg" style="height: 300px; margin-bottom: 20px;" alt="">
        ...
        <div class="row">
            <div class="col-sm-3">
                <div class="beta-person beta-person-full">
                    <div class="bets-img-hover">
                        <img src="assets/dest/images/history.jpg"  style="height: 200px"alt="">
                    </div>
            ...
            <div class="col-sm-3">
                <div class="beta-person beta-person-full">
                    <div class="bets-img-hover">
                        <img src="assets/dest/images/history4.jpg" style="height: 200px" alt="">
                    </div>
                    <div class="beta-person-body">
                        <h5>Bob Robertson</h5>
                        <p class="font-large">Web developer</p>
            ...
            <div class="col-sm-3">
                <div class="beta-person beta-person-full">
                    <div class="bets-img-hover">
                        <img src="assets/dest/images/history2.jpg" style="height: 200px" alt="">
                    </div>
                    <div class="beta-person-body">
                        <h5>Mike Greenwood</h5>
                        <p class="font-large">Web developer</p>
